...
import demoPlugin from './custom-linter-plugin-demo/index.js'
...
const useCustomPlugin = process.env.USE_CUSTOM_PLUGIN === 'true'
...
export default tseslint.config(
  {
    ...
    plugins: {
      'import-x': importX,
      ...(useCustomPlugin && { demo: demoPlugin }),
    },
    rules: {
      'no-debugger': 'error',
      ...
      ...(useCustomPlugin && { 'demo/demo-rule': 'error' }),
    },
  },
